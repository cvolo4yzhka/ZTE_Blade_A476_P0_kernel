...
//static int RG_Ratio_Typical = 0x136;   // 315
//static int BG_Ratio_Typical = 0x11a;	//291
...
static int update_awb_gain(int R_gain, int G_gain, int B_gain)
{
	...
	int AA11, AA12, AA13, AA14, AA15, AA16;
	...
	if (B_gain>0x400) {
		...
		AA11 = read_cmos_sensor(0x5032);
		AA12 = read_cmos_sensor(0x5033);
		AA13 = read_cmos_sensor(0x5034);
		AA14 = read_cmos_sensor(0x5035);
		AA15 = read_cmos_sensor(0x5036);
		AA16 = read_cmos_sensor(0x5037);
